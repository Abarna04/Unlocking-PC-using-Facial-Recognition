...
faces,ids = getImagesAndLabels(r'C:\Users\Abarna Balakrishnan\OneDrive\Desktop\python\dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists(r'C:\Users\Abarna Balakrishnan\OneDrive\Desktop\college work\MINI PROJECT\open cv\python\trainer.py')    # Save the model into trainer.yml
